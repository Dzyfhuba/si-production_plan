...
if(isset($_POST['change'])){
    ...
    // menyiapkan query
	$sql = "UPDATE mesin_produk_setengah_jadi SET  merk_mesin=:merk_mesin, tanggal_maintenance=:tanggal_maintenance, nama_mesin=:nama_mesin WHERE id_mesin_produk_setengah_jadi=:id_mesin_produk_setengah_jadi";
