...
if(isset($_POST['change'])){
    ...
    // menyiapkan query
	$sql = "UPDATE produk_setengah_jadi SET id_produk_setengah_jadi=:id_produk_setengah_jadi, nama_produk_setengah_jadi=:nama_produk_setengah_jadi, jumlah_produk_setengah_jadi=:jumlah_produk_setengah_jadi WHERE id_produk_setengah_jadi=:id_produk_setengah_jadi";
