                  ...
                  <div class="modal-body">
                    <form name="insert" id="insert" method="POST" action="insert.php">
                      <div class="form-group">
                        ...
                        <select class="w-100" id="id_mesin" name="id_mesin" placeholder="ID Mesin">
                            <?php foreach($option_mesin_jadi as $option) {?>
                                <option><?php echo $option["id_mesin_produk_jadi"] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="id_produk_setengah_jadi">id mesin</label>
                        <select class="w-100" id="id_produk_setengah_jadi" name="id_produk_setengah_jadi" placeholder="ID Produk Setengah Jadi">
                            <?php foreach($option_produk_setengah_jadi as $option) {?>
                                <option><?php echo $option["id_produk_setengah_jadi"] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
